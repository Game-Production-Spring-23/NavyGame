...
import { Screen3 } from "../Screen3/screen3.js";
...
export class GameDemoScene extends GameScene {
  constructor() {
    ...
    super.InitOverlays([Screen3]); // end InitOverlays
  } // end constructor
  ...
  Start(app, data) {
    ...
    backMidBar.drawRect(
      app.screen.width * backRatio * 0.5 - 50,
      0,
      100,
      app.screen.height
    );
    ...
    backLeftBar.drawRect(
      app.screen.width * backRatio - 50,
      0,
      100,
      app.screen.height
    );
    ...
    midMidBar.drawRect(
      app.screen.width * midRatio * 0.5 - 50,
      app.screen.height * 0.5,
      100,
      app.screen.height
    );
    ...
    foreMidBar.drawRect(
      app.screen.width * foreRatio * 0.5 - 50,
      app.screen.height * 0.75,
      100,
      app.screen.height
    );
    ...
    foreLeftBar.drawRect(
      app.screen.width * foreRatio - 50,
      app.screen.height * 0.75,
      100,
      app.screen.height
    );
